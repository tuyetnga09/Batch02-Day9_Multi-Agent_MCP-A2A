...
LEGAL_KNOWLEDGE = [
    ...
    # Bài 2.1: entry về luật lao động Việt Nam
    {
        "id": "labor_law",
...
# Bài 2.2: tool kiểm tra thời hiệu khởi kiện
@tool
...
async def main():
    ...
    # Bài 2.2: thêm tool mới vào danh sách
    ...
    if response.tool_calls:
        for tool_call in response.tool_calls:
            ...
            # Bài 2.2: xử lý cho check_statute_of_limitations
